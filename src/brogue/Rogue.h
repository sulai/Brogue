...
#define BROGUE_VERSION_STRING "1.7.3_audio-v8"
...
enum itemCategory {
	...
	PRENAMED_CATEGORY	= (FOOD | GOLD | AMULET | GEM | KEY | POWER),
    NEVER_IDENTIFIABLE  = (FOOD | CHARM | GOLD | AMULET | GEM | KEY | POWER),
    COUNTS_TOWARD_SCORE = (GOLD | AMULET | GEM),
	ALL_ITEMS			= (FOOD|POTION|WEAPON|ARMOR|STAFF|WAND|SCROLL|RING|CHARM|GOLD|AMULET|GEM|KEY|POWER),
};
...
#define staffPoison(enchant)				((int) (5 * pow(1.53, (double) (enchant) - 2) + FLOAT_FUDGE))
...
enum itemFlags {
	...
	ITEM_IS_KEY				= Fl(14),
	ITEM_ATTACKS_SLOWLY		= Fl(15),	// mace, hammer
...
//abaraba
	void cat_updateFieldOfViewDisplay();
